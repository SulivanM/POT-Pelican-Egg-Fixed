...
echo "-------------------------------------------------------------------------------------------------"
./POT/PathOfTitansServer.sh ${SERVER_MAP} -log -ServerName=$SERVER_NAME -MaxPlayers=$MAX_PLAYERS -Port=$SERVER_PORT -BranchKey=$BETA_BRANCH -AuthToken=$AG_AUTH_TOKEN -ServerGUID=$SERVER_GUID -Database=$SERVER_DATABASE
